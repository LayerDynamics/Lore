...
Convert research findings into a precise, file-level implementation blueprint. A blueprint is the bridge between research and code — it specifies exactly what to build before anyone writes a line.
...
### Step 3: Launch Blueprint Generation

Provide the agent with:
- The feature description
- All research findings found in Step 2 (or provided by user)
